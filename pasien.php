...
<div class="row no-gutters mt-5 side" >
    <div class="col-md-2 mt-5 pr-4 pt-1 sidebar" >
        ...
        <li class="nav-item">
            <a class="nav-link textactive" href="pasien.php"><i class="fas fa-users mr-2"></i>Daftar Pasien</a><hr class="bg-secondary">
        </li>
        <li class="nav-item">
...
<div class="col-md-10 p-5 pt-2">
    <h3><i class="fas fa-users mr-2"></i>Daftar Pasien</h3><hr>
        <form class="form-inline my-2 my-lg-0 ml-auto">
        <a href="#" id="tambahpas" class="btn btn-light mb-2 btndata"><i class="fas fa-plus-circle mr-2"></i>TAMBAH DATA PASIEN</a>
            <a href="laporan_pasien.php" class="btn btn-light mb-2 btndata"><i class="fas fa-print mr-2"></i>CETAK DATA PASIEN</a>
        ...
        <?php 
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $sql = mysqli_query($koneksi, "select * from pasien where Nama like '%".$cari."%' or NoKTP like '%".$cari."%' or PasienID like '%".$cari."%'");
            ...
            <tr>
                ...
                <a href="#" data-role="pop" data-id="<?php echo $data['PasienID'];?>">Edit</a>
                <i class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i>
                <a href="#" data-role="pop2" data-id ="<?php echo $data['PasienID']?>">Delete</a>
                <!-- Modal Edit -->
            ...
            ?>
                ...
                <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Hapus Data Pasien</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
