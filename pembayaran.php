...
<div class="row no-gutters mt-5 side" >
    <div class="col-md-2 mt-5 pr-4 pt-1 sidebar" >
        ...
        <li class="nav-item">
            <a class="nav-link textactive" href="pembayaran.php" ><i class="fas fa-credit-card mr-2"></i>Data Pembayaran</a><hr class="bg-secondary">
        </li>
        </ul>
    </div>
<!-- Akhir SideBar -->
...
<div class="col-md-10 p-5 pt-2">
    <h3><i class="fas fa-credit-card mr-2"></i>Data Pembayaran</h3><hr>
    <form class="form-inline my-2 my-lg-0 ml-auto">
        <a href="#" id="tambahbyr" class="btn btn-light mb-2 btndata"><i class="fas fa-plus-circle mr-2"></i>TAMBAH DATA PEMBAYARAN</a>
        ...
        <?php 
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $sql = mysqli_query($koneksi, "select * from pembayaran where PembayaranID like '%".$cari."%' or PemeriksaanID like '%".$cari."%' or Jumlah like '%".$cari."%' or CaraPembayaran like '%".$cari."%' or Tanggal like '%".$cari."%'");
            ...
            <tr>
                <td><?php echo $no++; ?></td>
                <td><?php echo $data['PembayaranID'];?></td>
                <td><?php echo $data['PemeriksaanID'];?></td>
                <td><?php echo $data['Jumlah'];?></td>
                <td><?php echo $data['CaraPembayaran'];?></td>
                <td><?php echo $data['Tanggal'];?></td>
                <td><i class="fas fa-edit bg-success p-2 text-white rounded"></i>
                <a href="#" data-role="pop" data-id="<?php echo $data['PembayaranID'];?>">Edit</a>
                <i class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i>
                <a href="#" data-role="pop2" data-id ="<?php echo $data['PembayaranID']?>">Delete</a>
                <!-- Modal Edit -->
                        ...
                        <form action="update_pembayaran.php" method="post">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label >Pembayaran ID</label>
                                    <input type="text" name="PembayaranID" class="form-control" id="PembayaranID" readonly>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="CaraPembayaran" class="form-control" id="CaraPembayaran">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
            ...
            ?>
                ...
                <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Hapus Data Pembayaran</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                        <form action="delete_pembayaran.php" method="post">
...
<div class="modal fade" id="ModalTambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label >PEMBAYARANID</label>
                <input type="text" name="PembayaranID" class="form-control" id="PembayaranID">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
                <label >PEMERIKSAANID</label>
        ...
        $("a[data-role=pop]").click(function(){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    console.log(row['PembayaranID']);
                    $("#PembayaranID").val(row['PembayaranID']);
                    $("#PemeriksaanID").val(row['PemeriksaanID']);
                    $("#Jumlah").val(row['Jumlah']);
                    $("#CaraPembayaran").val(row['CaraPembayaran']);
        ...
        $("a[data-role=pop2]").click(function(){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    var row = JSON.parse(data);
                    console.log(row['PembayaranID']);
                    $("#datadel2").val(row['PembayaranID']);
                    $("#datadel").text(row['PembayaranID']);
