...
<div class="row no-gutters mt-5 side">
    <div class="col-md-2 mt-5 pr-4 pt-1 sidebar">
        ...
        <li class="nav-item">
            <a class="nav-link textactive" href="fasilitas.php" ><i class="fas fa-procedures mr-2"></i>Daftar Fasilitas</a><hr class="bg-secondary">
        </li>
        <li class="nav-item">
...
<div class="col-md-10 p-5 pt-2">
    <h3><i class="fas fa-procedures mr-2"></i>Data Fasilitas</h3><hr>
    <form class="form-inline my-2 my-lg-0 ml-auto">
            <a href="#" id="tambahfas" class="btn btn-light mb-2 btndata"><i class="fas fa-plus-circle mr-2"></i>TAMBAH DATA FASILITAS</a>
            <a href="laporan_fasilitas.php" class="btn btn-light mb-2 btndata"><i class="fas fa-print mr-2"></i>CETAK DATA FASILITAS</a>
            <input class="form-control mr-sm-2 search" type="search" placeholder="Search" aria-label="Search" name="cari" style="margin-left: 38em;margin-bottom:0.7em">
        ...
        <?php 
            ...
            if(isset($_GET['cari'])){
                $cari = $_GET['cari'];
                $sql = mysqli_query($koneksi, "select * from fasilitas where Nama like '%".$cari."%' or Harga like '%".$cari."%' or FasilitasID like '%".$cari."%'");
            ...
            <tr>
                ...
                <a href="#" data-role="pop" data-id="<?php echo $data['FasilitasID'];?>">Edit</a>
                <i class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i>
                <a href="#" data-role="pop2" data-id ="<?php echo $data['FasilitasID']?>">Delete</a>
                <!-- Modal Edit -->
                <div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Ubah Data Fasilitas</h5>
            ...
            ?> 
                ...
                <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Hapus Data Fasilitas</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                        <form action="delete_fasilitas.php" method="post">
...
<!-- /Modah Tambah -->
    ...
    <script>
        ...
        $("a[data-role=pop]").click(function(){
            ...
            $.ajax({
                type:'POST',
                url: 'getfasilitas.php',
                data:{id:id},
                success:function(data){
                    console.log(data);
                    $('#ModalEdit').modal();
                    var row = JSON.parse(data);
                    console.log(row['FasilitasID']);
        ...
        $("a[data-role=pop2]").click(function(){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    var row = JSON.parse(data);
                    console.log(row['FasilitasID']);
                    $("#datadel2").val(row['FasilitasID']);
                    $("#datadel").text(row['FasilitasID']);
